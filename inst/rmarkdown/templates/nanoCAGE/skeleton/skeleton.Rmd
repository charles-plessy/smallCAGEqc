...
hanabiPlot(rar1, sampleSizeCounts, log='', type='l', ylab='number of TSS detected', xlab='number of unique molecule counts', main=paste("TSS discovery for", LIBRARY), GROUP=libs$Error)
...
hanabiPlot(rarg, sampleSizeCounts, log='', type='l', ylab='number of genes detected', xlab='number of unique molecule counts', main=paste("Gene discovery for", LIBRARY), GROUP=libs$Error)
...
hanabiPlot(rarU, sampleSizePairs, log='', type='l', ylab='number of molecules detected', xlab='number of properly mapped reads', main=paste("Transcript discovery for", LIBRARY), GROUP=libs$Error)
...
hanabiPlot(rarg[libs$Error=="0-No Error",], sampleSizeCounts, log='', type='l', ylab='number of genes detected', xlab='number of unique molecule counts', main=paste("Gene discovery for", LIBRARY), GROUP=libs[libs$Error=="0-No Error", "Run"])
